        ...
        <div className="space-y-8 max-w-7xl mx-auto pb-12 h-full flex flex-col">
            <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-6">
                ...
                <div className="flex gap-3">
                    <Button className="bg-electric-blue hover:bg-electric-blue/90 text-white rounded-xl px-6 font-bold h-11">
                        Gerar Lead Manual
                    </Button>
                </div>
            </div>
            ...
            <div className="flex flex-col md:flex-row gap-6 flex-1 min-h-0">
                {/* List Section */}
                <Card className="md:w-[400px] flex flex-col shrink-0 border-none bg-white dark:bg-[#111] shadow-xl rounded-3xl overflow-hidden">
                            ...
                            <CardHeader className="p-8 border-b border-black/5 dark:border-white/5 bg-gradient-to-br from-electric-blue/[0.03] to-transparent">
                                <div className="flex flex-col md:flex-row justify-between items-start gap-4">
                                    <div className="flex items-center gap-5">
                                        ...
                                        <div>
                                            <div className="flex items-center gap-3 mb-1">
                                                <h2 className="text-3xl font-extrabold text-pure-black dark:text-off-white">{selectedLead.name}</h2>
                                    ...
                                    <div className="flex gap-2">
                                        ...
                                        <Button className="h-12 px-6 rounded-2xl bg-[#25D366] hover:bg-[#20ba5a] text-white font-bold">
