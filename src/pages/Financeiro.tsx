                ...
                <CardHeader className="p-10 border-b border-black/5 dark:border-white/10">
                    <div className="flex items-center justify-between">
                        <div className="flex items-center gap-5">
                            ...
                            <div>
                                <CardTitle className="text-3xl font-black text-pure-black dark:text-off-white tracking-tight">Extrato Detalhado de Margens</CardTitle>
                                <CardDescription className="font-bold text-muted-foreground text-lg">Análise técnica de lucratividade operacional por transação.</CardDescription>
                            </div>
                        </div>
                        <Button variant="outline" className="rounded-2xl h-12 px-6 font-bold border-none bg-white/50 dark:bg-black/50 shadow-sm backdrop-blur-md">Filtrar por Vendedor</Button>
                    </div>
                </CardHeader>
