...
export interface AppState {
    ...
    notifications: any[]
    auditLogs: { id: string; userId: string; action: string; resource: string; agencyId: string; timestamp: string }[]
    addAuditLog: (log: { userId: string; action: string; resource: string; agencyId: string }) => void
